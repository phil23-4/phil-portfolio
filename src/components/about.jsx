...
import { faJava, faNodeJs, faPython, faHtml5, faJs, faCss3 } from "@fortawesome/free-brands-svg-icons";
                ...
                <div className="mx-auto max-w-6xl px-10 lg:px-8">
                    ...
                    <div className='flex flex-col md:flex-row'>
                        <div className="basis-full md:basis-1/2 order-3 md:order-none">
                            <div className="mx-auto max-w-2xl lg:mx-0">
                                <img src={standing} alt="" className="h-auto w-full object-contain" />
                            </div>
                        </div>
                        ...
                        <div className="basis-full md:basis-1/2">
                            <div className="mx-auto max-w-2xl lg:mx-0">
                                ...
                                <div className="mt-8">
                                    ...
                                    {experience.map((exp) => (
                                        <div key={exp.company} className="flex gap-x-3">
                                            ...
                                            <div className="w-56 text-end">
                                                <span className="text-xs font-semibold text-gray-700">{exp.date}</span>
                                            </div>
                                            {/* <!-- End Left Content --> */}
                                            ...
                                            <div className="grow pt-0.5 pb-8">
                                                ...
                                                {exp.tools.map((tool) => (
                                                    <div key={tool.id} className="mt-1 -ms-1 p-1 inline-flex items-center gap-x-2 text-sm  border border-transparent text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none">
                                    ...
                                    <a className="group flex group-hover:scale-x-105 mt-8 items-center gap-2 text-sm font-medium text-gray-800 hover:text-gray-500" href="#">
                                        Visit Full Resume
                                        <svg className="flex-shrink-0 size-4 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-col md:flex-row'>
                        <div className="basis-full md:basis-1/2">
                            <div className="mx-auto max-w-2xl lg:mx-0">
                                <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Education History</h2>
                                {/* <!-- Timeline --> */}
                                <div className="mt-8">
                                    {/* <!-- Item --> */}
                                    {education.map((edu) => (
                                        <div key={edu.name} className="flex gap-x-3">
                                            ...
                                            <div className="text-start">
                                                <span className="text-xs font-semibold text-gray-700">{edu.date}</span>
                                            </div>
                                            {/* <!-- End Left Content --> */}
                        ...
                        <div className="basis-full md:basis-1/2 order-3 md:order-none">
                            <div className="mx-auto max-w-2xl lg:mx-0">
                                <img src={work} alt="" className="h-auto w-full object-contain scale-x-[-1]" />
                            </div>
                        </div>
                    </div>

                    <>
                        <h2 className="mt-16 text-2xl py-12 font-bold tracking-tight text-gray-900">Technical Skills</h2>


                        <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                            {skills.map((skill) => (
                                <div key={skill.id} className=" flex flex-col justify-center border rounded-lg text-center p-4 md:p-5 md:hover:scale-105">

                                    <div className="flex justify-center items-center size-12 bg-gradient-to-br from-blue-600 to-violet-600 rounded-lg mx-auto">
                                        <FontAwesomeIcon icon={skill.icon} className="flex-shrink-0 size-7 text-white" />
                                    </div>
