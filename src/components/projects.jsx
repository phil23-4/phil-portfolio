...
const projects = [
    {
        ...
        image: amasunday,
        tools: [
            'HTML', 'React', 'Tailwind CSS', 'Next.js'
        ]
    },
    {
        id: 2,
            ...
            <div className="overflow-hidden bg-stone-50 py-24">
                <div className="mx-auto max-w-6xl px-10 lg:px-8">
                    ...
                    {projects.map((project) => (
                        <div key={project.id} className="relative mt-12 min-h-[35vh] md:min-h-[75vh] border border-gray-200 rounded-xl" style={{ background: `url(${project.image})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            ...
                            <div className="absolute bottom-0 start-0 end-0 max-w-xs md:max-w-lg text-center mx-auto p-6 md:start-auto md:text-start md:mx-0">
                                ...
                                <div className="px-5 py-4 inline-block bg-white rounded-lg md:p-7">
                                    <div className="md:block">
                                        ...
                                        <p className="mt-2 text-gray-800 hidden md:block">{project.description}</p>
                                    </div>
                                    <div className="mt-6 flex flex-wrap gap-2">
                                        {project.tools.map((tool) => (
                                            <span key={tool} className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl ">
                                                {tool}
                                            </span>
                                        ))}
                                    </div>
                                    ...
                                    <div className="md:mt-8">
                                        <a className="group flex group-hover:scale-x-105 mt-8 items-center gap-2 text-sm font-medium text-gray-800 hover:text-gray-500" href={project.link}>
                                            Visit website
