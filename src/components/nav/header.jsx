      ...
      >
        ...
        <div className="hidden lg:ml-8 lg:flex lg:items-center lg:border-l lg:border-slate-900/15 lg:pl-8">
          ...
          <div className="lg:ms-1 flex">
            <a className="inline-flex flex-shrink-0 justify-center items-center size-9 font-medium rounded-full text-gray-800 hover:bg-gray-200" href="https://www.figma.com/@phillipchapita" target="_blank">
            ...
            <a className="inline-flex flex-shrink-0 justify-center items-center size-9 font-medium rounded-full text-gray-800 hover:bg-gray-200" href="https://github.com/phil23-4" target="_blank">
